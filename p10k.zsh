# Generated by Powerlevel10k configuration wizard on 2026-04-10 at 17:49 CEST.
...
() {
  ...
  typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_FOREGROUND='#6c7086'
  ...
  #######################[ go_version: go version (https://golang.org) ]########################
  # Go version color.
  typeset -g POWERLEVEL9K_GO_VERSION_FOREGROUND='#89b4fa'
